...
public class Ebay {
	...
	public void findById(WebDriver driver) {
		...
		driver.get(URLPathConstants.EBAY_HOME_PAGE.toString()); // https://www.myntra.com/login?referer=https://www.myntra.com/
	...
	public void findByCSSSelector(WebDriver driver) {
		...
		driver.get(URLPathConstants.EBAY_HOME_PAGE.toString());
